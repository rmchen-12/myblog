...
import { actionTypes as ArticleTypes } from "../../reducers/admin/manageArticle";
import { actionTypes as NewArticleTypes } from "../../reducers/admin/manageNewArticle";
...
export function* editArticleFlow() {
  while (true) {
    ...
    if (res) {
      if (res.code === 0) {
        let { title, content, tags, _id } = res.data;
        yield put({ type: NewArticleTypes.SET_ARTICLE_ID, id: _id });
